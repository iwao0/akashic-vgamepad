...
個別に表示位置を変えたりする場合に使用してください。  
g.Spriteクラスのオブジェクトになっています。

#### スティックのスプライト

gamepad.stick.sprites
...
gamepad.buttons[index].sprites

- up: ボタンの画像
- hint: キーボードヒント

現状、ボタンは1枚だけの画像（up）となっていますが、今後overとdownを追加するかもしれません。
